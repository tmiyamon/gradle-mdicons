...
//import com.tmiyamon.mdicons.mdicons.task.CleanIcons
//import com.tmiyamon.mdicons.mdicons.task.CloneRepository
//import com.tmiyamon.mdicons.mdicons.task.CopyIconsByGroup
//import com.tmiyamon.mdicons.mdicons.task.CopyIconsByPattern
//import com.tmiyamon.mdicons.mdicons.task.SaveConfig
...
//
//    static {
//        File.memberClass.collectFileMatch = { nameFilter ->
//            def results = []
//            delegate.eachFileMatch(nameFilter) { results << it }
//            results
//        }
//    }
//
...
//
//        def task = [cloneRepository, cleanIcons, copyIconsByPattern, copyIconsByGroup, saveConfig]
//
//        project.plugins.withType(AppPlugin) {
//            project.task.findByName("preBuild").dependsOn(saveConfig.task)
//        }
...
////
////        project.plugins.withType(AppPlugin) {
////            project.task.findByName("preBuild").dependsOn(mainTask)
////        }
////        project.plugins.withType(LibraryPlugin) {
////            project.task.findByName("preBuild").dependsOn(mainTask)
////        }
